...
\>[16]{}\Varid{g}{}\<[20]%
\>[20]{}\mathrel{=}\Varid{inBlockchain}\comp \Varid{recBlockchain}\;(\Varid{anaBlockchain}\;\Varid{g})\comp \Varid{g}{}\<[E]%
\\
...
\column{20}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{allTransactions}\mathrel{=}{}\<[20]%
\>[20]{}\Varid{cataBlockchain}\;\alt{\Varid{g}}{\mathsf{conc}\comp ((\Varid{g})\times\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g}\mathrel{=}\p2\comp \p2{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=2cm{
\ensuremath{\Conid{A}\times(\mathit C\times\Conid{D})} \ar[r]^g &D\\}
\end{eqnarray*}

\par Se tivermos um Bcs:
\begin{eqnarray*}
\xymatrix@C=2cm{
\ensuremath{(\Conid{Block}\times\Conid{Transactions})} \ar[r]^{\ensuremath{\mathsf{conc}\comp (\Varid{g}\times\Varid{id})}} &Transactions\\}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{joinledges}\comp \Varid{cataBlockchain}\;\alt{\Varid{block2LedgeList}}{\mathsf{conc}\comp ((\Varid{block2LedgeList})\times\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{joinledges}\mathrel{=}\map \;\Varid{pairList2Pair}\comp \Varid{groupBy}\;(\Varid{groupByFst})\comp \Varid{sort}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{pairList2Pair}\;(\Varid{x})\mathrel{=}((\p1\comp \Varid{head})\;\Varid{x},(\Varid{sum}\;([\mskip1.5mu \p2\;(\Varid{y})\mid \Varid{y}\leftarrow \Varid{x}\mskip1.5mu]))){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{groupByFst}\;\Varid{x}\;\Varid{y}\mathrel{=}(\p1\;\Varid{x})\equiv (\p1\;\Varid{y}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{block2LedgeList}\mathrel{=}\Varid{concat}\comp (\map \;(\mathsf{conc}\comp \Varid{ledgeSinglePair}))\comp \p2\comp \p2{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{ledgeSinglePair}\mathrel{=}\conj{\Varid{singl}\comp (\Varid{id}\times\p1)}{\Varid{singl}\comp (\Varid{id}\times\Varid{negate})\comp \Varid{swap}\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix{
\ensuremath{\Conid{Block}} \ar[d]^{\ensuremath{\p2\comp \p2}}\\
\ensuremath{\Conid{Transactions}} \ar[d]^{\ensuremath{\map \;(\mathsf{conc}\comp \Varid{ledgeSinglePair})}} \\
\ensuremath{[\mskip1.5mu [\mskip1.5mu \Conid{Entity}\times\Conid{Value}\mskip1.5mu]\mskip1.5mu]} \ar[d]^{\ensuremath{\Varid{concat}}}\\
\ensuremath{[\mskip1.5mu \Conid{Entity}\times\Conid{Value}\mskip1.5mu]}}}
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix{
\ensuremath{(\Conid{Entity}\times(\Conid{Value}\times\Conid{Entity}))} \ar[d]^{ledgeSinglePair} \\
\ensuremath{[\mskip1.5mu \Conid{Entity}\times\Conid{Value}\mskip1.5mu]}\\}}
\end{eqnarray*}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\uncurry{(\equiv )}\comp \conj{\length \comp \Varid{n}}{\length \comp \Varid{nub}\comp \Varid{n}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{n}\mathrel{=}\Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pQ1}\mathrel{=}\p1{}\<[E]%
\\
\>[B]{}\Varid{pQ2}\mathrel{=}\p1\comp \p2{}\<[E]%
\\
\>[B]{}\Varid{pQ3}\mathrel{=}\p1\comp \p2\comp \p2{}\<[E]%
\\
\>[B]{}\Varid{pQ4}\mathrel{=}\p2\comp \p2\comp \p2{}\<[E]%
\\
\>[B]{}\Varid{q4x}\;(\Varid{x},\Varid{y},\Varid{z},\Varid{t})\mathrel{=}(\Varid{x}\times(\Varid{y}\times(\Varid{z}\times\Varid{t}))){}\<[E]%
\\
\>[B]{}\Varid{q4xu}\;\Varid{h}\mathrel{=}\Varid{q4x}\;(\Varid{h},\Varid{h},\Varid{h},\Varid{h}){}\<[E]%
\\
\>[B]{}\Varid{cellBuild}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{q4toList}\;((\Varid{x},(\Varid{y},(\Varid{z},\Varid{d}))))\mathrel{=}\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}\Varid{z}\mathbin{:}\Varid{d}\mathbin{:}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inQTree}\;(i_1\;\Varid{c})\mathrel{=}\Varid{cellBuild}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{inQTree}\;(i_2\;\Varid{x})\mathrel{=}\Conid{Block}\;(\Varid{pQ1}\;\Varid{x})\;(\Varid{pQ2}\;\Varid{x})\;(\Varid{pQ3}\;\Varid{x})\;(\Varid{pQ4}\;\Varid{x}){}\<[E]%
\\
\>[B]{}\Varid{outQTree}\;(\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}i_1\;(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\
\>[B]{}\Varid{outQTree}\;(\Conid{Block}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\Varid{t})\mathrel{=}i_2\;(\Varid{x},(\Varid{y},(\Varid{z},\Varid{t}))){}\<[E]%
\\
\>[B]{}\Varid{baseQTree}\;\Varid{f}\;\Varid{h}\mathrel{=}(\Varid{f}\times\Varid{id})+(\Varid{q4xu}\;\Varid{h}){}\<[E]%
\\
...
\\
\>[B]{}\Varid{hyloQTree}\;\Varid{h}\;\Varid{g}\mathrel{=}{}\<[17]%
\>[17]{}\Varid{cataQTree}\;\Varid{h}\comp \Varid{anaQTree}\;\Varid{g}{}\<[E]%
\\
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{cellBuild}\comp (\Varid{id}\times\Varid{swap})}{\Varid{inQTree}\comp i_2\comp \Varid{z}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{z}\;(\Varid{q1},(\Varid{q2},(\Varid{q3},\Varid{q4})))\mathrel{=}(\Varid{q3},(\Varid{q1},(\Varid{q4},\Varid{q2}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=2cm{
\ensuremath{\Conid{A}\times(\mathit B\times\mathit C)} \ar[r]^{\ensuremath{(\Varid{id}\times\Varid{swap})}} & \ensuremath{\Conid{A}\times(\mathit C\times\mathit B)}\\}
\end{eqnarray*}

Troca das células de um bloco para obtermos a rotação
\begin{eqnarray*}
\xymatrix@C=2cm{
\ensuremath{\Conid{A}\times(\mathit B\times(\mathit C\times\Conid{D})} \ar[r]^{\ensuremath{(\Varid{z})}} & \ensuremath{\mathit C\times(\Conid{A}\times(\Conid{D}\times\mathit B))}\\}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{i}\;\Varid{x}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{cellBuild}\comp (\lambda (\Varid{a},(\Varid{b},\Varid{c}))\to (\Varid{a},(\Varid{b}\mathbin{*}\Varid{i},\Varid{c}\mathbin{*}\Varid{i})))}{\Varid{inQTree}\comp i_2}\;\Varid{x}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;(\Varid{f}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\;(\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a})\mathrel{=}\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{r})\;(\mathrm{255}\mathbin{-}\Varid{g})\;(\mathrm{255}\mathbin{-}\Varid{b})\;(\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compressAux}\mathbin{::}\Conid{QTree}\;\Varid{a}\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{compressAux}\;(\Conid{Block}\;(\Conid{Cell}\;\Varid{a}\;\Varid{b1}\;\Varid{c1})\;(\Conid{Cell}\;\anonymous \;\Varid{b2}\;\Varid{c2})\;(\Conid{Cell}\;\anonymous \;\Varid{b3}\;\Varid{c3})\;(\Conid{Cell}\;\anonymous \;\Varid{b4}\;\Varid{c4}))\mathrel{=}(\Conid{Cell}\;\Varid{a}\;(\Varid{b1}\mathbin{+}\Varid{b2})\;(\Varid{c1}\mathbin{+}\Varid{c3})){}\<[E]%
\\
\>[B]{}\Varid{compressAux}\;\Varid{x}\mathrel{=}\Varid{x}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compAux}\mathbin{::}\Conid{Int}\to (\Conid{Int},\Conid{QTree}\;\Varid{a})\to (\Varid{a},(\Conid{Int},\Conid{Int}))+(((\Conid{Int},\Conid{QTree}\;\Varid{a}),((\Conid{Int},\Conid{QTree}\;\Varid{a}),((\Conid{Int},\Conid{QTree}\;\Varid{a}),(\Conid{Int},\Conid{QTree}\;\Varid{a}))))){}\<[E]%
\\
\>[B]{}\Varid{compAux}\;\Varid{i}\;(\anonymous ,\Conid{Cell}\;\Varid{x}\;\Varid{b}\;\Varid{c})\mathrel{=}i_1\;(\Varid{x},(\Varid{b},\Varid{c})){}\<[E]%
\\
\>[B]{}\Varid{compAux}\;\Varid{i}\;(\Varid{r},\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\mathbf{if}\;(\Varid{r}\mathbin{>}\Varid{i})\;\mathbf{then}\;i_2\;((\Varid{r}\mathbin{-}\mathrm{1},\Varid{a}),((\Varid{r}\mathbin{-}\mathrm{1},\Varid{b}),((\Varid{r}\mathbin{-}\mathrm{1},\Varid{c}),(\Varid{r}\mathbin{-}\mathrm{1},\Varid{d}))))\;\mathbf{else}\;i_1\mathbin{\$}(\Varid{a1},(\Varid{b1},\Varid{c1})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Conid{Cell}\;\Varid{a1}\;\Varid{b1}\;\Varid{c1})\mathrel{=}\Varid{fullCompression}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{fullCompression}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{cellBuild}}{\Varid{compressAux}\comp \Varid{inQTree}\comp i_2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{i}\;\Varid{x}\mathrel{=}\Varid{anaQTree}\;(\Varid{compAux}\;\Varid{i})\;(\Varid{depthQTree}\;\Varid{x},\Varid{x}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=3cm{
\ensuremath{(\Conid{A}\times\mathit B)\times(\Conid{A}\times\mathit B)\times(\Conid{A}\times\mathit B)\times(\Conid{A}\times\mathit B)}  \ar[r]^{\ensuremath{\Varid{q4xu}\;(\p1)}}  &\ensuremath{\Conid{A}\times(\Conid{A}\times(\Conid{A}\times\Conid{A}))}\\}
\end{eqnarray*}
\begin{eqnarray*}
\xymatrix@C=4cm{
\ensuremath{\Conid{A}\times(\Conid{A}\times(\Conid{A}\times\Conid{A}))} \ar[r]^{\ensuremath{(\mathbin{+}\mathrm{1})\comp \Varid{maximum}\comp \Varid{q4toList}}} & \ensuremath{\Conid{A}}\\}
\end{eqnarray*}
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outlineQTree}\;\Varid{f}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{mat}}{\Varid{joinmats}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{mat}\;(\Varid{x},(\Varid{i},\Varid{j}))\mathrel{=}matrix\;\Varid{j}\;\Varid{i}\;(\lambda (\Varid{a},\Varid{b})\to \mathbf{if}\;((\Varid{a}\equiv \mathrm{1}\mathrel{\vee}\Varid{a}\equiv \Varid{j})\mathrel{\vee}(\Varid{b}\equiv \mathrm{1}\mathrel{\vee}\Varid{b}\equiv \Varid{i}))\;\mathbf{then}\;(\Varid{f}\;\Varid{x})\;\mathbf{else}\;\Conid{False}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{joinmats}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}{\,\updownarrow\,}\Varid{b}){\,\leftrightarrow\,}(\Varid{c}{\,\updownarrow\,}\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{unmakeP}\comp \conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}\comp \Varid{makeP}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{makeP}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{unmakeP}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ensuremath{\Varid{g}\comp \Varid{inN}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})}
\qed
\end{eqnarray*}
...
\ensuremath{\Varid{s}\comp \Varid{inN}\mathrel{=}\alt{\underline{\mathrm{1}}}{\succ \comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})}
\qed
\begin{eqnarray*}
\start
  Juntando as duas funções para usar "Fokkinga":
    \ensuremath{\begin{lcbr}\Varid{g}\comp \Varid{inN}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})\\\Varid{s}\comp \Varid{inN}\mathrel{=}\alt{\underline{\mathrm{1}}}{\succ \comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})\end{lcbr}}
  %
    \just\equiv{Fokkinga}
  %
  \ensuremath{\conj{\Varid{s}}{\Varid{g}}\mathrel{=}\cata{\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}}}{\alt{\underline{\mathrm{1}}}{(\mathbin{+}\mathrm{1})\comp \p2}}}}
  \qed
  \end{eqnarray*}

  \begin{eqnarray*}
  \start
  Seja \ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}\cata{\Varid{i}}}
    e  \ensuremath{\conj{\Varid{g}}{\Varid{s}}\mathrel{=}\cata{\Varid{j}}}
  %
    \just\equiv{recorrendo aos resultados de usar Fokkinga, lei Banana-split, Absorção-x}
    \ensuremath{\conj{\cata{\Varid{i}}}{\cata{\Varid{j}}}\mathrel{=}\cata{\conj{\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}}}{\alt{\succ \comp \Varid{k}}{\succ \comp \p2}}\comp \Conid{F}\;\p1}{\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}}}{\alt{\underline{\mathrm{1}}}{\succ \comp \p2}}\comp \Conid{F}\;\p2}}}
  %
  \just\equiv{Lei da troca -- 2 vezes}
  \ensuremath{\cata{\conj{\alt{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\Varid{mul}}{\succ }\comp \p2}}{\cdot }\comp \Conid{F}\;\p1\;\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{mul}}{\succ }\comp \p2}\comp \Conid{F}\;\p2}}
  %
...
\column{20}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{branchBuild}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{inFTree}\mathrel{=}\alt{\Conid{Unit}}{\Varid{branchBuild}}{}\<[E]%
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Unit}\;\Varid{u})\mathrel{=}i_1\;\Varid{u}{}\<[E]%
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}i_2\;(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\
\>[B]{}\Varid{baseFTree}\;\Varid{f}\;\Varid{g}\;\Varid{h}\mathrel{=}{}\<[20]%
\>[20]{}\Varid{g}+(\Varid{f}\times(\Varid{h}\times\Varid{h})){}\<[E]%
\\
\>[B]{}\Varid{recFTree}\;\Varid{f}{}\<[13]%
\>[13]{}\mathrel{=}\Varid{baseFTree}\;\Varid{id}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{bimap}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{cataFTree}\;(\Varid{inFTree}\comp \Varid{baseFTree}\;\Varid{f}\;\Varid{g}\;\Varid{id}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\mathrm{1}\mathbin{+}\N_0\times\Conid{Float}}
           \ar[d]_-{\ensuremath{\Varid{anaFtree}\;\Varid{generateSquare}}}
&
    \ensuremath{\N_0\times\Conid{Float}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{anaFtree}\;\Varid{generateSquare})}}
           \ar[l]_-{\ensuremath{\Varid{outNat}\times\Varid{id}}}
\\
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{PTree}}
&
     \ensuremath{\Conid{PTree}}
           \ar[l]^-{\ensuremath{\Varid{generateSquare}}}
}
\end{eqnarray*}
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{drawPTree}\mathrel{=}\Varid{joinPics}\comp (\Varid{anaFTree}\;\Varid{nextCall})\comp \Varid{setup}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{setup}\;\Varid{x}\mathrel{=}(((\mathrm{0},\mathrm{0}),\mathrm{0}),\Varid{x}){}\<[E]%
\\
\>[5]{}\hsindent{8}{}\<[13]%
\>[13]{}\mbox{\onelinecomment split (split (split (const 0) (const 0)) (const 0)) id}{}\<[E]%
\\[\blanklineskip]%
...
\begin{eqnarray*}
\xymatrix@C=3cm{
\ensuremath{\Varid{a}}  \ar[r]^{\ensuremath{\Varid{singletonbag}}}  &\ensuremath{\Conid{Bag}\;\Varid{a}}\\}
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix@C=3cm{
\ensuremath{(\Conid{Bag}\;(\Conid{Bag}\;\Varid{a}))}  \ar[r]^{\ensuremath{\mu }}  &\ensuremath{\Conid{Bag}\;\Varid{a}}\\}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mu \;(\mathit B\;\Varid{d})\mathrel{=}\mathit B\;(\Varid{concat}\;([\mskip1.5mu \Varid{concat}\;(\Varid{replicate}\;\Varid{a}\;\Varid{x})\mid ((\mathit B\;\Varid{x}),\Varid{a})\leftarrow \Varid{d}\mskip1.5mu])){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
